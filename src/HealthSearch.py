...
from InvertedIndex import readCache, writeCache, getStopWords, addFile, addDir, removeFile, removeDir, updateIndex, \
...
stopWordsFile, cacheFilePath = "Ignore\\StopWords.ignore", "Ignore\\InvertedIndex.ignore"
